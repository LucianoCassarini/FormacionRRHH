...
archivo = pd.read_excel("documento.xlsx")
...
if len(aprobadosNoCertificados) != 0:
    print("Hay " + str(len(aprobadosNoCertificados)) + " participantes aprobados en panel que no fueron certificados: ")
...
if len(certificadosNoAprobados) != 0:
    print("Se emitieron " + str(len(certificadosNoAprobados)) + " certificados a participantes que aparecen Reprobados en panel: ")
...
if len(certificadosNoInscriptos) != 0:
    print("Se emitieron " + str(len(certificadosNoInscriptos)) + " certificados a participantes que no aparecen en panel: ")
